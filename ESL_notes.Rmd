...
Idea is if a portion of the data causes a bad fit, a bootstrapped sample with out that portion of the data may result in a better estimated model. Models need relatively similiar levels of complexity.
