...
Tree algorithsm are highly variable because of hierarchical structure. Also results in a non-smooth prediction for regression.

Is the response always in a finite interval for tree algorithms?
